        ...
        for (int i=0; i<1000;i++)
            {
                ...
                AGeschw[i] = _lenkerSensor.getLenkergeschwindigkeit();
                ...
                Motor.runLenkermotor();



                // _lenkerSensor.readCounter();
                // Serial.print(_lenkerSensor.getLenkerwinkel());
                // Serial.print(" ");
                // Serial.print(_lenkerSensor.getLenkergeschwindigkeit());
                // Serial.print(" ");
                // Serial.println(_lenkerSensor.getLenkerbeschleunigung());
        ...
        for (int i=0; i<1000;i++)
            {
                ...
                Serial.print(";");
                //Serial.print("Winkel:");
                Serial.print(APoti[i]);
                Serial.print(";");
                Serial.println(AGeschw[i]);
