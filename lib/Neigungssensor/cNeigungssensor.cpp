	...
	: _bno(Adafruit_BNO055(bno_addr)), _calibRestored(false), _refreshRate(100)
{
	...
	if (!_bno.begin())
	{
		...
		LOG->addEntry(cStatusLogEntry(EStatusLogEntryType::FATAL_ERROR, MODULE_NEIGUNG, "BNO055 nicht erkannt. Verkabelung oder I2C Adresse falsch!?"));
